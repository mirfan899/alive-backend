...
from helpers import extract_feature, load_pretrained_model
...
def insert_image_to_milvus(image_path, video_path):
    ...
    client.insert(collection_name=collection_name, data=[{"descriptors": descriptors.tolist(), "image_path": image_video_mapping}])
